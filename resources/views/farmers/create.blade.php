...
<div class="container">
    ...
    <div class="col-md-6">
        <input id="pan" type="text" class="form-control" maxlength="10" minlength="10" name="pan"
            value="{{ old('pan') }}">
...
<div class="row">
    <button type="submit" class="btn btn-success col-md-6 col-md-offset-4"> {{ __('forms.register') }}
    </button>
</div>

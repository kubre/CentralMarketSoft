    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="form-group{{ $errors->has('pan') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="pan" type="text" class="form-control" name="pan" maxlength="10" minlength="10"
                        value="{{ old('pan') }}">
            ...
            <div class="form-group{{ $errors->has('aadhar') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="aadhar" type="text" class="form-control" name="aadhar" minlength="12" maxlength="12"
                        value="{{ old('aadhar') }}">

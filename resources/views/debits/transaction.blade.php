	...
	<div style="float:right;"> दुकान प्रत </div>
		...
		<div style="margin:20px;">
			<div style="margin-bottom:20px;margin-top:30px;margin-left:20px;">
                ...
                {{ $transaction->debit->farmer->middle_name }} 
                {{ $transaction->debit->farmer->last_name }} 
                </span>
			</div>
			<div style="margin:20px;">
			...
			<div style="margin:20px;">
				बाकी रक्कम (रु.) :  <span style="font-family: monospace"> {{ number_format($transaction->debit->amount) }} </span>
			</div>
